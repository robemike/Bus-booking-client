...
const BookingForm = () => {
  return (
    <div id="booking-container" className=' max-w-lg mx-auto p-6 bg-gray-100 rounded-lg shadow-md'>
      <form className='flex flex-col'>
        ...
        <button id='btnbooking' type='submit' className='w-full py-2 bg-blue-600 text-white font-bold rounded hover:bg-blue-700'>Book Now</button>
      </form>
    </div>
  );
}
